package de.novatec.http11.webflux.server.config;

import io.micrometer.core.instrument.MeterRegistry;
import de.novatec.http11.webflux.server.support.metrics.EventLoopGroupMetricsBinder;
...
public class NettyLoopResourcesConfiguration {
     ...
     * provides {@link LoopResources} and {@link ConnectionProvider}.
     * {@link ConnectionProvider} is only used by clients.
