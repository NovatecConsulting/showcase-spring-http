 ...
 * <ul>
 *   <li>{@link org.springframework.boot.web.embedded.netty.NettyReactiveWebServerFactory} which provides {@link reactor.netty.http.server.HttpServer} is provided by ReactiveWebServerFactoryConfiguration.EmbeddedNetty class.</li>
 ...
 *   </li>
 *   <li>{@link reactor.netty.http.server.HttpServer} can be configured by {@link NettyServerCustomizer} which are applied to{@link org.springframework.boot.web.embedded.netty.NettyReactiveWebServerFactory} by ReactiveWebServerFactoryConfiguration.EmbeddedNetty.</li>
 * </ul>
 */
