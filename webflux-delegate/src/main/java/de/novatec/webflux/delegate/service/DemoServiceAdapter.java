package de.novatec.webflux.delegate.service;

import de.novatec.webflux.delegate.support.collections.Maps;
...
import static de.novatec.webflux.delegate.support.collections.Maps.entry;
...
public class DemoServiceAdapter {
    ...
    public DemoServiceAdapter(
            ...
            @Value("${target.server.url}") String serviceURL) {
