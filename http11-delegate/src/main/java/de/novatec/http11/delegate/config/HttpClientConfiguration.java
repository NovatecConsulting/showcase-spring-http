package de.novatec.http11.delegate.config;

import de.novatec.http11.delegate.support.metrics.MetricsBinder;
import de.novatec.http11.delegate.support.metrics.MicrometerSupport;
import de.novatec.http11.delegate.support.reflection.ReflectionSupport;
...
public class HttpClientConfiguration {
    ...
    public MetricsBinder<PoolingHttpClientConnectionManager> poolingHttpClientConnectionManagerMetricsBinder(MeterRegistry meterRegistry, MetricsProperties properties) {
        return (connectionManager, poolName) ->
                new PoolingHttpClientConnectionManagerMetricsBinder(
                        connectionManager,
                        poolName,
                        MicrometerSupport.toMicrometerTags(properties.getTags()))
    ...
    public HttpComponentsClientHttpRequestFactory httpRequestFactoryDefault(MetricsBinder<PoolingHttpClientConnectionManager> metricsBinder) {
        ...
        ReflectionSupport.doIfValueIsPresent(factory.getHttpClient(), "connManager", PoolingHttpClientConnectionManager.class, connManager ->
